...
// estpipwcplusplus
Rcpp::List estpipwcplusplus(double tau, int KK, arma::ivec N, double TBAND, int NP, arma::mat X, arma::cube ZT, arma::mat CENSOR, arma::mat DELTA, arma::mat WGHT, arma::vec BETA0);
RcppExport SEXP _sievePH_estpipwcplusplus(SEXP tauSEXP, SEXP KKSEXP, SEXP NSEXP, SEXP TBANDSEXP, SEXP NPSEXP, SEXP XSEXP, SEXP ZTSEXP, SEXP CENSORSEXP, SEXP DELTASEXP, SEXP WGHTSEXP, SEXP BETA0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    ...
    Rcpp::traits::input_parameter< arma::mat >::type WGHT(WGHTSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type BETA0(BETA0SEXP);
    rcpp_result_gen = Rcpp::wrap(estpipwcplusplus(tau, KK, N, TBAND, NP, X, ZT, CENSOR, DELTA, WGHT, BETA0));
    return rcpp_result_gen;
END_RCPP
}
// estpaugcplusplus
Rcpp::List estpaugcplusplus(double tau, double tstep, int ntgrid, double TBAND, int KK, arma::ivec N, int NP, arma::mat X, arma::cube ZT, arma::mat CENSOR, arma::mat DELTA, arma::mat WGHT, arma::mat DRHOipw, arma::vec BETA0);
RcppExport SEXP _sievePH_estpaugcplusplus(SEXP tauSEXP, SEXP tstepSEXP, SEXP ntgridSEXP, SEXP TBANDSEXP, SEXP KKSEXP, SEXP NSEXP, SEXP NPSEXP, SEXP XSEXP, SEXP ZTSEXP, SEXP CENSORSEXP, SEXP DELTASEXP, SEXP WGHTSEXP, SEXP DRHOipwSEXP, SEXP BETA0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type BETA0(BETA0SEXP);
    rcpp_result_gen = Rcpp::wrap(estpaugcplusplus(tau, tstep, ntgrid, TBAND, KK, N, NP, X, ZT, CENSOR, DELTA, WGHT, DRHOipw, BETA0));
    return rcpp_result_gen;
END_RCPP
}
// GDIST2Ncplusplus
