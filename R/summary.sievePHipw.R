...
#' Summarizing Mark-Specific Proportional Hazards Model Fits with Missing Values Inferred by Inverse Probability Weighting of Complete Cases
#'
#' \code{summary} method for an object of class \code{sievePHipw}.
#'
#' @param object an object of class \code{sievePHipw}, usually a result of a call to \code{\link{sievePHipw}}
...
#'
#' @details
#' \code{print.summary.sievePHipw} prints a formatted summary of results. Inference about coefficients in the mark-specific proportional hazards model is tabulated. Additionally, a summary is generated
...
#'
#' @return
#' An object of class \code{summary.sievePHipw}, which is a list with the following components:
#' \itemize{
...
#' sfit$te
#'
#' @seealso \code{\link{sievePHipw}}
#'
#' @export
summary.sievePHipw <- function(object, markGrid,
