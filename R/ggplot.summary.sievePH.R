...
#' @param axisLabSize a numeric number specifying the font size of axis title in the bottom panel (\code{15} by default)
#' @param tickLabSize a numeric number specifying the font size of axis text in the bottom panel (\code{14} by default)
#' @param legendLabSize a numeric number specifying the font size of legend text in the bottom panel (\code{11} by default)
...
#' @param txLabSize a numeric number specifying the size of placebo and treatment labels (\code{5} by default).
#' @param boxplotWidth a numeric number specifying the width of the boxplot (\code{0.8}) by default
#' @param jitterFactor a numeric number specifying the amount of vertical jitter (\code{NULL} by default: this means the jitter values will occupy 80% of the implied bins.
#' @param jitterSeed a numeric number setting the seed of R's random number generator for jitter (\code{0} by default)
